...
export default function HomePage() {
  ...
  if (pageState.status === 'loading') {
    return (
      <LoadingState
        url={pageState.displayUrl}
        analysisType={pageState.analysisType}
        mode={mode}
      />
    );
  }
        ...
        <div className="mb-10">
          <div className="relative h-1 w-full overflow-hidden">
            <div
              ...
              style={{ background: 'linear-gradient(to right, #22c55e 0%, #eab308 35%, #f97316 65%, #ef4444 100%)' }}
            />
          </div>
          <div className="grid grid-cols-4 mt-3">
            {[
              ...
              <div key={s.range} className="pr-4">
                <p className="text-[11px] text-[var(--muted)] mb-0.5 num" style={{ fontFamily: 'var(--font-mono)' }}>
                  {s.range}
                </p>
